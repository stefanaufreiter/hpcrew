      ...
      <div class="memberFlex px-12">
        ...
        class="cycle-slideshow" data-cycle-fx=fadeout
          ...
          <img
           ...
           :src="transformImage(eimg.filename, '600x350/smart')" class="memberImage" width="600px" height="350px"></img>
        </div>
        <div v-else>
          <img :src="transformImage(memberContent.img.filename, '600x350/smart')" class="memberImage" width="600px" height="350px"></img>
        </div>
